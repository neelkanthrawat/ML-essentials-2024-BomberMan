...
# For training
TRAIN_FROM_THE_SCRATCH= 1
AGENT_SAVED =   'No_loop_anymore_lc_9x9_64x64_better_escape_bomb.pt'
...
def setup_training(self):
    ...
    self.alpha, self.gamma= 0.9,0.65#i dont think we are using alpha anywhere in training 
    self.batch_size= 500
...
def game_events_occurred(self, old_game_state: dict, self_action: str, 
    ...
    self.bomb_flag =0
    # looping
    (x, y) = new_game_state['self'][3]# not suing this anymore
...
def reward_from_events(self, events: List[str]) -> int:
    ...
    *This is not a required function, but an idea to structure your code.*
    ...
    """
    game_rewards = {
        e.COIN_COLLECTED: 9000,# earlier it was 100
        ...
        e.BOMB_DROPPED:3000,#2900,#1#-1,# -5 # 50# initally it was 3500
        e.INVALID_ACTION: -4000,#-100,# earlier it was -10 
        e.KILLED_SELF: -5000,# earlier it was -800
        e.GOT_KILLED: -3000,
        e.CRATE_DESTROYED: 500,# earlier it was 30
        ### we need to add some more custom rewards here. else it won't work
        CLOSE_T0_CRATE : 150,#  not using this anymore
        CLOSE_TO_SAFE_TILE : 150,# not using this anymore
        BOMB_NEAR_CRATE : 4000,#3500,
        BOMB_FAR_FROM_CRATE: -3200,#-1000,#-1000,
        BOMB_DROPPED_NAIVELY: -4200,#-3000,
        AWAY_FROM_CRATE: -3050,# not using this anymore
        AWAY_FROM_SAFE_TILE: -2000,### not using this anymore  as well
        STUPID_BOMB: -800,# not using this anymore
        AGENT_LOOP: -5000# not using this  anymore
    } 
